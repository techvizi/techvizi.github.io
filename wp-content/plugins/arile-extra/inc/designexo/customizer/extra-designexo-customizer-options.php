...
function arileextra_designexo_customizer_selective_refresh_settings($wp_customize) {
	...
	$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';	
		...
		array(
            'default' => __('WE BUILD CREATIVE INTERIOR DESIGN','arile-extra'),
			'sanitize_callback' => 'designexo_sanitize_text',
			'transport' => $selective_refresh,
		));	
    ...
    // Project
		...
		array(
            'default' => __('ALL INTERIOR DESIGN SOLUTIONS','arile-extra'),
			'sanitize_callback' => 'designexo_sanitize_text',
			'transport' => $selective_refresh,
		));	
	...
	// Testimonial
		...
		array(
            'default' => __('WHAT OUR CLIENTS SAY ABOUT US','arile-extra'),
			'sanitize_callback' => 'designexo_sanitize_text',
			'transport' => $selective_refresh,
		));	
