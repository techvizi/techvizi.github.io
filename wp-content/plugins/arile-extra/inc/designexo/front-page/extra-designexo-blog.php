...
$designexo_blog_area_title = get_theme_mod('designexo_blog_area_title', __('OUR LATEST NEWS','arile-extra'));
$designexo_blog_area_des = get_theme_mod('designexo_blog_area_des', __('Recent Updates','arile-extra'));
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php if($designexo_blog_area_des != null): ?>
						<p class="theme-section-subtitle wow animate fadeInUp" data-wow-delay=".3s"><?php echo wp_kses_post($designexo_blog_area_des); ?></p>
					<?php endif; ?>
					
					<?php if($designexo_blog_area_title != null): ?>
						<h2 class="theme-section-title wow animate fadeInUp" data-wow-delay=".3s"><?php echo wp_kses_post($designexo_blog_area_title); ?></h2>
					<?php endif; ?>
