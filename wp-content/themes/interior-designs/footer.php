...
?>
    <footer role="contentinfo">
        ...
        <div id="footer">
        	<div class="container">
                <p><?php interior_designs_credit_link(); ?> <?php echo esc_html(get_theme_mod('interior_designs_footer_copy',__('By ThemesCaliber','interior-designs'))); ?></p>
            </div>
        </div>

        <?php if( get_theme_mod( 'interior_designs_show_back_to_top',true) != '') { ?>
            ...
            if($interior_designs_scroll_lay == 'Left'){ ?>
                <a href="#" class="scrollup left"><span><?php echo esc_html( get_theme_mod('interior_designs_back_to_top_text',__('Back to Top', 'interior-designs' )) ); ?><?php if(get_theme_mod('interior_designs_back_to_top_icon') != 'None') {?><i class="<?php echo esc_html(get_theme_mod('interior_designs_back_to_top_icon','fas fa-arrow-up')); ?> ml-2"></i><?php }?></span><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('interior_designs_back_to_top_text',__('Back to Top', 'interior-designs' )) ); ?></span></a>
