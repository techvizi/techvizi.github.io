...
class Interior_Designs_Icon_Changer extends WP_Customize_Control{
      public $type = 'icon';
        ...
        ?>
            <label>
                  ...
                  <div class="selected-icon">
                        <i class="<?php echo esc_attr($this->value()); ?>"></i><span class="icons-class"><?php echo esc_html($this->value()); ?></span>
                        <span><i class="fa fa-angle-down"></i></span>
                  </div>

                  <ul class="icon-list">
                        <div class="social-icon-search">
                              <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'interior-designs'); ?>">
                        </div>
                        <?php
                        $interior_designs_font_awesome_icon_array = interior_designs_font_awesome_icon_array();
                        foreach ($interior_designs_font_awesome_icon_array as $interior_designs_font_awesome_icon) {
                              $icon_class = $this->value() == $interior_designs_font_awesome_icon ? 'icon-active' : '';
                              echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($interior_designs_font_awesome_icon).'"></i>
                                    <span class="icons-class">'.esc_attr($interior_designs_font_awesome_icon).'</span>
                              </li>';
                        }
                        ?>
                  </ul>
...
function interior_designs_customizer_script() {
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'interior_designs_customizer_script' );

if(!function_exists('interior_designs_font_awesome_icon_array')){
    function interior_designs_font_awesome_icon_array(){
        return array("None", 
            "fab fa-500px",
