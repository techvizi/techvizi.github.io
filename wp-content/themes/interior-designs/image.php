                    ...
                    <div class="col-lg-8 col-md-8">
            			<?php while ( have_posts() ) : the_post(); ?>    
                            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                <div class="entry-content">
                                    ...
                                    <div class="entry-attachment">
                                        <div class="attachment">
                                            <?php interior_designs_the_attached_image(); ?>
                                        </div>
                                ...
                                <?php edit_post_link( __( 'Edit', 'interior-designs' ), '<footer role="contentinfo" class="entry-meta"><span class="edit-link">', '</span></footer>' ); ?>
                            </article>    
                            <?php
