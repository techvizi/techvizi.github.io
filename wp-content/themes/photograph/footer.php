				 ...
				 if ( is_active_sidebar( 'photograph_footer_options' ) ) :
					...
					<div class="copyright">
						<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | 
									...
									<?php  date_i18n(__('Y','photograph')) ; ?> <a title="<?php echo esc_attr__( 'WordPress', 'photograph' );?>" target="_blank" href="<?php echo esc_url( 'https://wordpress.org' );?>"><?php esc_html_e('WordPress','photograph'); ?></a> | <?php echo '&copy; ' . esc_html__('Copyright All right reserved ','photograph'); ?>
						<?php
